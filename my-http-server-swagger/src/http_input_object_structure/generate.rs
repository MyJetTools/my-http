...
pub fn generate(ast: &syn::DeriveInput) -> (proc_macro::TokenStream, bool) {
    ...
    let result = if let Some(generic) = GenericData::new(ast) {
        ...
        quote! {
            ...
            impl<'s, #generic_token_stream> TryFrom<my_http::core::InputParamValue<'s>> for #struct_name #generic_ident {
                type Error = my_http::core::HttpFailResult;

                fn try_from(value: my_http::core::InputParamValue) -> Result<Self, Self::Error> {
                    value.from_json()
                }
            }

            impl #generic_token_stream TryFrom<my_http::core::HttpRequestBody> for #struct_name #generic_ident {
                type Error = my_http::core::HttpFailResult;

                fn try_from(value: my_http::core::HttpRequestBody) -> Result<Self, Self::Error> {
        ...
        quote! {
            ...
            impl<'s> TryFrom<my_http::core::InputParamValue<'s>> for #struct_name {
                type Error = my_http::core::HttpFailResult;
            ...
            impl TryFrom<my_http::core::HttpRequestBody> for #struct_name {
                type Error = my_http::core::HttpFailResult;
