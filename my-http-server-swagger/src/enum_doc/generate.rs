...
pub fn generate(ast: &syn::DeriveInput, as_integer: bool) -> Result<TokenStream, syn::Error> {
    ...
    let result = quote::quote! {
        ...
        impl<'s> TryInto<#struct_name> for my_http::core::InputParamValue<'s>{
        ...
        impl my_http::controllers::controllers::documentation::DataTypeProvider for #struct_name {
            fn get_data_type() -> my_http::controllers::controllers::documentation::data_types::HttpDataType {
                #use_documentation;
