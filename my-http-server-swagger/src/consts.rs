...
pub fn get_http_input_parameter_with_ns() -> TokenStream {
    quote!(
        my_http::controllers::controllers::documentation::in_parameters::HttpInputParameter
    )
}
...
pub fn get_http_context() -> TokenStream {
    quote!(my_http::core::HttpContext)
}

pub fn get_http_fail_result() -> TokenStream {
    quote!(my_http::core::HttpFailResult)
}

pub fn get_http_ok_result() -> TokenStream {
    quote!(my_http::core::HttpOkResult)
}
...
pub fn get_http_action_description_with_ns() -> TokenStream {
    quote!(my_http::controllers::controllers::documentation::HttpActionDescription)
}

pub fn get_http_route() -> TokenStream {
    quote!(my_http::controllers::controllers::HttpRoute)
}
