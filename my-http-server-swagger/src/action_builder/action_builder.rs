...
pub fn build_action(attr: TokenStream, input: TokenStream) -> Result<TokenStream, syn::Error> {
    ...
    let result = quote::quote! {
        ...
        impl my_http::controllers::controllers::actions::GetDescription for #struct_name{
        ...
        impl my_http::controllers::controllers::actions::HandleHttpRequest for #struct_name{
